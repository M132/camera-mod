...
public class VideoModule implements CameraModule,
    ...
    private void initializeVideoControl() {
        if(mPreferenceGroup == null) loadCameraPreferences();
    ...
    private void readVideoPreferences() {
        ...
        if (quality != 8) {
            ...
            mProfile = CamcorderProfile.get(mCameraId, 1);
            mProfile.duration         = 30;
            mProfile.quality          = 1;
            mProfile.fileFormat       = Integer.parseInt(mPreferences.getString(CameraSettings.KEY_VIDEOCAMERA_CONTAINER, mActivity.getString(R.string.pref_video_container_default)));
            mProfile.videoCodec       = Integer.parseInt(mPreferences.getString(CameraSettings.KEY_VIDEOCAMERA_VCODEC, mActivity.getString(R.string.pref_video_vcodec_default)));
            mProfile.videoBitRate     = Integer.parseInt(mPreferences.getString(CameraSettings.KEY_VIDEOCAMERA_VBITRATE, mActivity.getString(R.string.pref_video_vbitrate_default)));
            mProfile.videoFrameRate   = Integer.parseInt(mPreferences.getString(CameraSettings.KEY_VIDEOCAMERA_FPS, (String) mPreferenceGroup.findPreference(CameraSettings.KEY_VIDEOCAMERA_FPS).getEntryValues()[0]).split("-")[1])/1000;
            mProfile.videoFrameWidth  = Integer.parseInt(mPreferences.getString(CameraSettings.KEY_VIDEOCAMERA_RESOLUTION, (String) mPreferenceGroup.findPreference(CameraSettings.KEY_VIDEOCAMERA_RESOLUTION).getEntryValues()[0]).split("x")[0]);
            mProfile.videoFrameHeight = Integer.parseInt(mPreferences.getString(CameraSettings.KEY_VIDEOCAMERA_RESOLUTION, (String) mPreferenceGroup.findPreference(CameraSettings.KEY_VIDEOCAMERA_RESOLUTION).getEntryValues()[0]).split("x")[1]);
            mProfile.audioCodec       = Integer.parseInt(mPreferences.getString(CameraSettings.KEY_VIDEOCAMERA_ACODEC, mActivity.getString(R.string.pref_video_acodec_default)));
            mProfile.audioBitRate     = Integer.parseInt(mPreferences.getString(CameraSettings.KEY_VIDEOCAMERA_ABITRATE, mActivity.getString(R.string.pref_video_abitrate_default)));
            mProfile.audioSampleRate  = Integer.parseInt(mPreferences.getString(CameraSettings.KEY_VIDEOCAMERA_ASAMPLERATE, mActivity.getString(R.string.pref_video_asamplerate_default)));
            mProfile.audioChannels    = Integer.parseInt(mPreferences.getString(CameraSettings.KEY_VIDEOCAMERA_ACHANNELS, mActivity.getString(R.string.pref_video_achannels_default)));
            getDesiredPreviewSize();
        }
    }
    ...
    private void setCameraParameters() {
        ...
        int minFps = Integer.parseInt(mPreferences.getString(CameraSettings.KEY_VIDEOCAMERA_FPS, (String) mPreferenceGroup.findPreference(CameraSettings.KEY_VIDEOCAMERA_FPS).getEntryValues()[0]).split("-")[0]);
        int maxFps = Integer.parseInt(mPreferences.getString(CameraSettings.KEY_VIDEOCAMERA_FPS, (String) mPreferenceGroup.findPreference(CameraSettings.KEY_VIDEOCAMERA_FPS).getEntryValues()[0]).split("-")[1]);
