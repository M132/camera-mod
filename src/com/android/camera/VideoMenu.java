...
public class VideoMenu extends PieController
    ...
    private String[] mOtherKeysCustom;
    ...
    public void initialize(PreferenceGroup group) {
        ...
        mOtherKeys = new String[] {
                ...
                CameraSettings.KEY_VIDEOCAMERA_FPS
        };

        mOtherKeysCustom = new String[] {
                CameraSettings.KEY_STORAGE,
                CameraSettings.KEY_POWER_SHUTTER,
                CameraSettings.KEY_VIDEOCAMERA_JPEG,
                CameraSettings.KEY_VIDEOCAMERA_CONTAINER,
                CameraSettings.KEY_VIDEOCAMERA_VCODEC,
                CameraSettings.KEY_VIDEOCAMERA_RESOLUTION,
                CameraSettings.KEY_VIDEOCAMERA_VBITRATE,
                CameraSettings.KEY_VIDEOCAMERA_FPS,
                CameraSettings.KEY_VIDEOCAMERA_ACODEC,
                CameraSettings.KEY_VIDEOCAMERA_ABITRATE,
                CameraSettings.KEY_VIDEOCAMERA_ASAMPLERATE,
                CameraSettings.KEY_VIDEOCAMERA_ACHANNELS
        };
        ...
        item.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(PieItem item) {
                if (mPopup == null || mPopupStatus != POPUP_FIRST_LEVEL) {
                    ...
                    if(Integer.valueOf(mPreferenceGroup.findPreference(CameraSettings.KEY_VIDEO_QUALITY).getValue()) == 8){
                        popup.initialize(mPreferenceGroup, mOtherKeysCustom);
                    } else {
